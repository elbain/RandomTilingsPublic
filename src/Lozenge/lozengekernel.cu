...
__global__ void RotateTilesKernel(curandStateMtgp32* d_status, char* tiling, const int N) // fix all things with N
{
...
__global__ void UpdateTilesKernel(char* tiling1, char* tiling2, char* tiling3, const int N, const int t)
{
